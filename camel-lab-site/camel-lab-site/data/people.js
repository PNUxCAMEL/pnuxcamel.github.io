...
window.STUDENTS = [
  ...
  { name: "Euichan Heo",   degree: "M.S. course",  topics: ["Imitation Learning", "Bimanual Manipulation"],           email: "hec1013@pusan.ac.kr",     photo: IMG + "EuichanHeo.png" + RAW },
  ...
  { name: "Jintae Kim",    degree: "B.S. course",  topics: ["Mechanical Design", "Soft Robotics"],                    email: "jintae2001@naver.com",    photo: IMG + "JintaeKim.png" + RAW },
  { name: "Sangbum Son",   degree: "B.S. course",  topics: ["Reinforcement Learning", "Manipulation"],                email: "sontkdqja@pusan.ac.kr",   photo: IMG + "SangbeomSon.png" + RAW },
  { name: "Seongjun Heo",  degree: "B.S. course",  topics: ["Imitation Learning", "Manipulation"],                    email: "timetravel1016@gmail.com",photo: IMG + "SeongjunHeo.jpg" + RAW },
  { name: "Sangwon Yi",    degree: "B.S. course",  topics: ["Reinforcement Learning", "Locomotion"],                  email: "yangbanpro@gmail.com",    photo: PLACEHOLDER },
];

window.ALUMNI = [
  { name: "Jihoon Park",     degree: "Ph.D. Candidate", year: "",     employment: "" },
  { name: "Dongju Kim",      degree: "M.S.",  year: "2026", employment: "Institute for Human & Machine Cognition (IHMC)" },
  { name: "Yeongsu Choi",    degree: "M.S.",  year: "2026", employment: "Openpath Robotics" },
